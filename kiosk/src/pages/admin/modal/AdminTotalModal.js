const AdminTotalModal = ({adminTotalModalContent, closeAdminTotalModal}) => {
    return (
            ...
            <div className="O-modal" style={{width: '40%', height: '50%'}}>
                <div className="O-modal-content">
                    <div className="O-modal-header" style={{height: '20%'}}>
                        <div className="O-modal-close-Btn" onClick={closeAdminTotalModal}>
                    ...
                    <div className="O-modal-side-order" style={{height: '40%', textAlign: 'center'}}
                        ...
                        <p className={'M-font O-font-middle-size'}>{adminTotalModalContent}</p>
                    </div>
                    <div className="O-modal-side-footer M-flex-j-center" style={{marginTop: '30px', height: '15%'}}>
                        <div className="O-receipt-modal-btn" onClick={closeAdminTotalModal}
